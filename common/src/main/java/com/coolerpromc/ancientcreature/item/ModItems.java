...
public class ModItems {
    ...
    public static final RegistryHandler.Items<EggFossilItem> EGG_FOSSIL = registerItem("egg_fossil", p -> new EggFossilItem(p.stacksTo(1).component(ModDataComponents.IDENTIFICATION_FAILED.get(), false).component(ModDataComponents.SPECIES.get(), Species.TRICERATOPS).component(ModDataComponents.IDENTIFIED.get(), false).component(ModDataComponents.IS_DIRTY.get(), true).component(ModDataComponents.FOSSIL_COMPLETENESS.get(), new FossilCompleteness(0f))));
