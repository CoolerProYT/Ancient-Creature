...
public class ItemEvents {
    public static void onItemTooltip(ItemStack stack, Item.TooltipContext tooltipContext, TooltipFlag tooltipFlag, List<Component> components) {
        ...
        GenomeCompleteness genomeCompleteness = stack.get(ModDataComponents.GENOME_COMPLETENESS.get());
        if (genomeCompleteness != null){
            genomeCompleteness.addToTooltip(tooltipContext, components::add, tooltipFlag, stack.getComponents());
        }
