...
public class DNAExtractorScreen extends AbstractContainerScreen<DNAExtractorMenu> {
    public static final Identifier TEXTURE = Constants.id("textures/gui/screen/dna_extractor.png");
    public static final Identifier ARROW = Constants.id("container/progress_arrow");

    public DNAExtractorScreen(DNAExtractorMenu menu, Inventory inventory, Component title) {
