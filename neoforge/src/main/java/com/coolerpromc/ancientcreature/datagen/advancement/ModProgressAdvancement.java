...
public class ModProgressAdvancement extends AdvancementSubProvider {
    public ModProgressAdvancement(BootstrapContext<Advancement> output) {
        super(output);
    }
    ...
    public void generate() {
        ...
        AdvancementHolder root = Advancement.Builder.advancement()
            .rootDisplay(
                ModItems.NETHERITE_CHISEL.asItem(),
                title("root"),
                description("root"),
            ...
            .save(output, Constants.id("progression/root").toString());

        AdvancementHolder craftChisel = itemAdvancement(
            root, ModItems.STONE_CHISEL, "craft_chisel", AdvancementType.TASK,
            "obtain_chisel",
            InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, ModItemTags.CHISELS).build())
        );
        ...
        AdvancementHolder obtainFossil = Advancement.Builder.advancement()
            ...
            .save(output, Constants.id("progression/obtain_fossil").toString());
        ...
        AdvancementHolder cleaningTable = itemAdvancement(
            ...
            "obtain_cleaning_table", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.FOSSIL_CLEANING_TABLE.getItem())
        );
        ...
        AdvancementHolder identificationChamber = itemAdvancement(
            ...
            "obtain_identification_chamber", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.FOSSIL_IDENTIFICATION_CHAMBER.getItem())
        );
        ...
        AdvancementHolder dnaExtractor = itemAdvancement(
            ...
            "obtain_dna_extractor", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.DNA_EXTRACTOR.getItem())
        );

        AdvancementHolder extractDna = itemAdvancement(
            dnaExtractor, ModItems.DNA_SAMPLE, "extract_dna", AdvancementType.GOAL,
            "obtain_dna_sample", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.DNA_SAMPLE)
        );
        ...
        AdvancementHolder genomeSequencer = itemAdvancement(
            ...
            "obtain_genome_sequencer", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.GENOME_SEQUENCER.getItem())
        );
        ...
        AdvancementHolder completeGenome = itemAdvancement(
            ...
            "obtain_completed_genome", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.GENOME_CARTRIDGE_COMPLETED)
        );
        ...
        AdvancementHolder embryogenesisChamber = itemAdvancement(
            ...
            "obtain_embryogenesis_chamber", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.EMBRYOGENESIS_CHAMBER.getItem())
        );
        ...
        AdvancementHolder fertilizedEgg = itemAdvancement(
            ...
            "obtain_fertilized_egg", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.FERTILIZED_ANCIENT_EGG)
        );
        ...
        AdvancementHolder incubator = itemAdvancement(
            ...
            "obtain_incubator", InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.INCUBATOR.getItem())
        );

        itemAdvancement(
            incubator, ModItems.BABY_CREATURE_CAPSULE, "revive_creature", AdvancementType.CHALLENGE,
            "obtain_baby_creature", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.BABY_CREATURE_CAPSULE)
        );
    }

    private AdvancementHolder itemAdvancement(AdvancementHolder parent, ItemLike icon, String name, AdvancementType type, String criterionName, Criterion<?> criterion) {
        return Advancement.Builder.advancement()
            .parent(parent)
            .display(icon.asItem(), title(name), description(name), type, true, true, false)
            .addCriterion(criterionName, criterion)
            .save(output, Constants.id("progression/" + name).toString());
    }
